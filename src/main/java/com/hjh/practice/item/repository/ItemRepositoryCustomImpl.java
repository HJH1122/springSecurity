...
import com.hjh.practice.item.dto.QMainItemDto;
import com.hjh.practice.item.entity.Item;
import com.hjh.practice.item.entity.QItem;
import com.hjh.practice.item.entity.QItemImg;
...
public class ItemRepositoryCustomImpl implements ItemRepositoryCustom  {
    ...
    private BooleanExpression regDtsAfter(String searchDateType) {
        ...
        return item.created.after(dateTime);                    // created가 dateTime보다 이후인지 반환
    }
